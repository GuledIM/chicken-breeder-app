...
class ChickenManager:
    ...
    def update_chicken(self):
        ...
        for chicken in self.chickens:
            ...
            if chicken.id == chicken_id:
                ...
                # Planned to add code that would alllow user to skip breed and age to update name and vice versa but best to keep
                # it simple for now
    ...
    def save_to_csv(self, filename=r"C:\Users\GuledM(DE-LON16)\Documents\projects\chicker-breeder-app\Week-3.5\data\chickens.csv"): # persist to csv upon closing application 
    ...
    def load_from_csv(self, filename=r"C:\Users\GuledM(DE-LON16)\Documents\projects\chicker-breeder-app\Week-3.5\data\chickens.csv"): #upon launching the program we load from the csv file
